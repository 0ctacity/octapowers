...
const OCTAPOWERS_VERSION = readOctapowersVersion();
...
function readOctapowersVersion() {
...
function brandMarkup() {
  const version = escapeHtmlText(OCTAPOWERS_VERSION);
  const text = 'Octapowers v' + version;

  return '<div class="brand"><span class="brand-copy">' + text + '</span></div>';
}
