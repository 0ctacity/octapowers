...
mkdir -p src test docs/octapowers/plans

# Create a simple implementation plan
cat > docs/octapowers/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/octapowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/octapowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"octapowers:subagent-driven-development"' "$SESSION_FILE"; then
