#!/usr/bin/env bash
# Regression check: Octapowers should not route new worktrees through the old
...
ROTOTILL_SPEC="$REPO_ROOT/docs/octapowers/specs/2026-04-06-worktree-rototill-design.md"
ROTOTILL_PLAN="$REPO_ROOT/docs/octapowers/plans/2026-04-06-worktree-rototill.md"
